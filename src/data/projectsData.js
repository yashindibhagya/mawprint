...
export const projectsData = [
    ...
    },
    {
        ...
        description: "GestureConnect is a comprehensive mobile application designed to bridge the communication gap between the deaf and hearing communities. The app provides real-time bidirectional translation between sign language and text, coupled with an interactive learning platform to promote inclusive communication and accessibility.",
